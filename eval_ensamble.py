...
def main():
    ...
    G1.load_state_dict(torch.load(drive_path + 'SingleSource_'+sources[0] + '/G.pkl'))
    C1.load_state_dict(torch.load(drive_path + 'SingleSource_'+sources[0] + '/C.pkl'))
    ...
    G2.load_state_dict(torch.load(drive_path + 'SingleSource_'+sources[1] + '/G.pkl'))
    C2.load_state_dict(torch.load(drive_path + 'SingleSource_'+sources[1] + '/C.pkl'))
    ...
    G3.load_state_dict(torch.load(drive_path + 'SingleSource_'+sources[2] + '/G.pkl'))
    C3.load_state_dict(torch.load(drive_path + 'SingleSource_'+sources[2] + '/C.pkl'))
    ...
    model_path = drive_path + 'triplet_match/BEST_checkpoint.pth'
